...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.FilterHolder> {
    ...
    public void onBindViewHolder(FilterHolder filterHolder, final int i) {
        ...
        filterHolder.filterRoot.setOnClickListener(new View.OnClickListener() { // from class: com.cameraediter.iphone11pro.adapter.FilterAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                FilterAdapter.this.onFilterChangeListener.onFilterChanged(i);
            }
        });
    }
